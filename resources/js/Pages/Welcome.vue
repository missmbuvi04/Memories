        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    ...
                    <p
                        class="mt-6 text-lg leading-8 text-gray-600 dark:text-white"
                    >
                        Relive your special moments with us and capture the
                        heartfelt smiles you might have missed. Let us turn your
                        event into timeless memories!
                    </p>
